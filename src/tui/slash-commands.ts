...
export const slashCommands: SlashCommandSpec[] = [
  ...
  { name: "graph", group: "Kernel", usage: "/graph [session_id]", description: "Review work dependencies." },
  { name: "task", group: "Kernel", usage: "/task <task_id> [session_id]", description: "Review one work item." },
