...
export const slashCommands: SlashCommandSpec[] = [
  ...
  { name: "approve", group: "Core", usage: "/approve [approval_id] [message]", description: "Approve the current plan or one pending approval.", completionPriority: 48 },
  ...
  { name: "leases", group: "Kernel", usage: "/leases [saved_work|lease_id]", description: "Inspect workspace leases and write boundaries." },
  ...
  { name: "task", group: "Kernel", usage: "/task <task_id> [saved_work]", description: "Review one work item." },
  ...
  { name: "swarm", group: "Agents", usage: "/swarm [summary|ownership|mailbox <actor_id>|agent <actor_id>]", description: "Show Swarm participants, workspace claims, mailbox, and conflicts.", completionPriority: 35 },
  ...
  { name: "worker", group: "Agents", usage: "/worker <worker_id>", description: "Review one team member." },
