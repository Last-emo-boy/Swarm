...
export const slashCommands: SlashCommandSpec[] = [
  ...
  { name: "plugins", group: "Config", usage: "/plugins [plugin|all]", description: "Summarize discovered extension plugins and manifest diagnostics." },
  ...
  { name: "mcp", group: "Config", usage: "/mcp [server|all]", description: "Summarize configured MCP server states." },
  { name: "mcp-refresh", group: "Config", usage: "/mcp-refresh <server>", description: "Reconnect one configured MCP stdio server and refresh its tool catalog." },
