...
export const slashCommands: SlashCommandSpec[] = [
  ...
  { name: "symphony-daemon", group: "Automation", usage: "/symphony-daemon [loop]", description: "Inspect TUI-managed automation loops." },
  ...
  { name: "symphony-stop", group: "Automation", usage: "/symphony-stop [loop|all] [--cancel-running]", description: "Stop local automation loops." },
